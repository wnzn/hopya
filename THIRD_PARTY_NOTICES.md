...
Hopya includes modified icon paths from [Runeicons](https://github.com/Nexvyn/runeicons).
...
The Runeicons paths used in `apps/web/src/components/SolidIcon.tsx` have been
modified for Hopya's shared icon component and icon naming scheme.
