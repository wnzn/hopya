export const permissions = ['items:read', 'items:write', 'items:delete', 'comments:manage', 'structure:write', 'members:manage', 'roles:manage', 'workspace:manage', 'agent:use'] as const
